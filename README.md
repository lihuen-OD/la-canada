...
- **Mascotas (Etapa 5M, sin commit)**: `/pets` con listado por tipo, ficha con KPIs, historial clínico (anulación auditada), gestión de tipos y foto en Object Storage privado vía el backend (requiere `OBJECT_STORAGE_*`). Ver `docs/ARCHITECTURE.md` §25.
- **Todavía no hay dashboard ni otros módulos nuevos** (ni reales ni mock). Lo ya implementado en frontend comprende autenticación, usuarios, Tareas, Desempeño, Stock, Gallinero y Mascotas.
