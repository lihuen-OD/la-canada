...
- **Todavía no hay dashboard ni otros módulos de negocio implementados** en `frontend/` (ni reales ni mock) — eso sigue siendo la Etapa 4. Lo que sí existe, completo, es el flujo de autenticación (Etapa 3C) y la administración de usuarios (Etapa 3D, ver más abajo).
