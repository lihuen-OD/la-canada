...
Ver `docs/MIGRATION_PLAN.md` para la etapa vigente. El proyecto completó las Etapas 0 (documentación), 1 (estructura profesional), 2/2.1/2.2 (modelo de datos, seed real, Object Storage) y 2.3 (retiro seguro del prototipo heredado — ver regla 9). Sin conexión a Neon, sin autenticación implementada, sin avance a la Etapa 3.
